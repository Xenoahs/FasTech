<?php
	...
	if(isset($_POST['edit'])){
		...
		try{
			$stmt = $conn->prepare("UPDATE customers SET email=:email, password=:password, first_name=:firstname, last_name=:lastname, address=:address, contact_number=:contact WHERE id=:id");
