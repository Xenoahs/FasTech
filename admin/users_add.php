...
if(isset($_POST['add'])){
    ...
    if($row['numrows'] > 0){
        ...
        try{
            $stmt = $conn->prepare("INSERT INTO customers (email, password, first_name, last_name, address, contact_number, photo, status, creation_date) VALUES (:email, :password, :firstname, :lastname, :address, :contact, :photo, :status, :created_on)");
