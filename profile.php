                            ...
                            <div class="box-body">
                                ...
                                <div class="col-sm-9">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <h4><?php echo $user['first_name'].' '.$user['last_name']; ?>
                                                <span class="pull-right">
	        									<a href="#edit" class="btn btn-success btn-flat btn-sm" data-toggle="modal"><i class="fa fa-edit"></i> Edit</a>
	        								</span>
                                            </h4>
                                            <h4><?php echo $user['email']; ?></h4>
                                            <h4><?php echo (!empty($user['contact_number'])) ? $user['contact_number'] : 'N/a'; ?></h4>
                                            <h4><?php echo (!empty($user['address'])) ? $user['address'] : 'N/a'; ?></h4>
                                            <h4><?php echo date('M d, Y', strtotime($user['creation_date'])); ?></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    try{
                                        ...
                                        foreach($stmt as $row){
                                            ...
                                            foreach($stmt2 as $row2){
                                                $subtotal = $row2['product_price']*$row2['quantity'];
                                                $total += $subtotal;
                                            }
                                            echo "
	        									<tr>
